...
import { MOCK_RELEASES, issuesByRelease, SEVERITY } from '../data/mockData'
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold">Release Reports</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {MOCK_RELEASES.map((release) => {
          ...
          return (
            <div
              key={release.id}
              className={cn('rounded-xl border bg-card p-5 flex flex-col gap-4', healthColor)}
            >
              {/* Header */}
              ...
              <div className="flex gap-2 mt-auto pt-1">
                <Button
                  ...
                  size="sm"
                  className="flex-1"
                  onClick={() => exportCSV(release, issues)}
                >
