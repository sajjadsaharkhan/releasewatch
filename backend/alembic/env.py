...
# ── import app config + every model so Alembic sees the metadata ──────────────
from app.config import settings
from app.db.base import Base  # noqa: F401 — registers TimestampMixin
...
# ── offline mode (emit SQL to stdout, no DB connection needed) ────────────────
